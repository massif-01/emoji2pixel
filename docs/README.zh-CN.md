...
**核心功能**：为WS2812 LED Matrix（LED矩阵屏）提供专业的动画和像素画预览，支持模拟真实LED显示效果。
...
### 🎨 **强大的渲染引擎（WS2812 LED Matrix专业预览）**
- **双重渲染模式**：
  - **理想模式**：模拟配备柔光装置的WS2812，每颗LED光线均匀扩散，呈现专业显示效果
  - **裸渲染模式**：模拟裸露WS2812的真实观感，直接显示LED像素点，无柔光处理
